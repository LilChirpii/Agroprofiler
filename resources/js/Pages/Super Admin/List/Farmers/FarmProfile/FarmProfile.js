...
export default function FarmProfile({ auth, farmer }) {
    ...
    return (_jsxs(Authenticated, { user: auth.user, children: [_jsx(Head, { title: `${farmer.firstname} ${farmer.lastname} ` }), _jsx(ToastContainer, {}), _jsxs("div", { className: "grid grid-cols-4 h-full gap-0 p-[0.5rem]", children: [_jsxs("div", { className: "relative left-0 h-full border-r px-4 py-2 border-slate-200 ", children: [_jsx("div", { children: _jsx("h2", { className: "text-xl mt-2 text-gray-800 leading-tight", children: _jsx(_Fragment, { children: _jsx("div", { className: "flex justify-between mb-4 dark:text-white", children: _jsxs(Link, { href: "/farmers", children: [_jsxs("span", { className: "flex mb-4", children: [_jsx(ChevronLeft, { size: 24 }), " Back"] }), " "] }) }) }) }) }), _jsxs("div", { className: "flex dark:text-green-600 content-center justify-center mt-10 font-semibold text-[24px] flex-wrap ", children: [farmer.firstname, " ", _jsx("br", {}), " ", farmer.lastname] }), _jsx("div", { className: "flex content-center justify-center mt-1", children: farmer.status === "registered" ? (_jsx(_Fragment, { children: _jsx("div", { className: "text-slate-600 p-1 rounded-2xl text-xs", children: farmer.rsbsa_ref_no }) })) : (_jsx(_Fragment, { children: _jsx("div", { className: "bg-red-600 p-1 px-2 text-white rounded-lg text-[10px]", children: "unregistered" }) })) }), _jsxs("div", { className: "mt-1", children: [_jsxs("div", { className: "mt-4", children: [_jsx("span", { className: "text-slate-400 text-sm ml-3 mt-4", children: "Info" }), " "] }), _jsxs("div", { className: "pl-3", children: [_jsx("div", { className: "mt-2 flex gap-1", children: _jsxs("span", { className: "flex gap-2 dark:text-white text-slate-700 text-sm", children: [_jsx(House, { size: 18 }), farmer.barangay?.name, ", Davao del Sur"] }) }), _jsx("div", { className: "mt-2", children: _jsxs("span", { className: "flex gap-2 dark:text-white text-slate-700 text-sm", children: [_jsx(Cake, { size: 18 }), farmer.dob] }) }), _jsx("div", { className: "mt-2", children: _jsxs("span", { className: "flex gap-2 dark:text-white text-slate-700 text-sm", children: [_jsx(Phone, { size: 18 }), "09676979568"] }) }), farmer["4ps"] === "yes" ? (_jsx(_Fragment, { children: _jsx("div", { className: "mt-2", children: _jsxs("span", { className: "flex gap-2 dark:text-white text-slate-700 text-sm", children: [_jsx(HandCoins, { size: 20 }), "4ps Beneficiary"] }) }) })) : (""), farmer.pwd === "yes" ? (_jsx(_Fragment, { children: _jsx("div", { className: "mt-2", children: _jsxs("span", { className: "flex gap-2 dark:text-white text-slate-700 text-sm", children: [_jsx(Accessibility, { size: 20 }), "Person with disabilty"] }) }) })) : ("")] })] })] }), _jsxs("div", { className: "relative col-span-3 right-0 h-full px-6 py-4", children: [_jsx("span", { className: "text-lg text-[30px] dark:text-green-600 text-slate-700 font-semibold", children: "Data History" }), _jsx("div", { className: "w-full h-full mt-4", children: _jsxs(Tabs, { children: [_jsxs(Tab, { label: "Allocation", children: [_jsx("div", { className: "flex justify-end px-4", children: _jsx(Button, { className: "bg-green-800 text-white mb-4 p-2 px-2 rounded-lg hover:bg-green-900 hover:shadow-md ", onClick: () => handleOpenModal("allocation"), children: _jsxs("span", { className: "text-sm flex gap-2", children: [_jsx(Plus, { size: 18 }), "Add Allocation"] }) }) }), _jsx(Timeline, { items: allocations.map((allocation) => ({
                                                        ...
                                                        { key: "img", label: "File" },
                                                        { key: "date", label: "Date" },
                                                    ] })] })] }) })] }), _jsxs(Modal, { show: modalOpen, onClose: () => setModalOpen(false), children: [modalType === "allocation" && (_jsxs("div", { className: "p-10 h-50", children: [_jsx("h2", { className: "font-semibold mb-2 text-2xl dark:text-green-600 text-green-800", children: formData.id
                                            ? "Edit Allocation"
                                                ...
                                                formData.id
                                                    ...
                                                    : handleSaveAllocation();
                                                            ...
                                                            date_received: e.target.value === "Yes"
                                                                ...
                                                                : "",
                                                        }), className: "w-full border rounded-md p-2 border-slate-400\n                                                    bg-white text-black dark:bg-transparent dark:text-white\n                                                    dark:border-gray-600", children: [_jsx("option", { value: "", className: "dark:bg-transparent", children: "Select Value" }), _jsx("option", { className: "dark:bg-transparent", value: "no", children: "No" }), _jsx("option", { className: "dark:bg-transparent", value: "yes", children: "Yes" })] }), _jsx("label", { className: "block mt-4 dark:text-white font-semibold px-4 text-[15px]", children: "If yes, when was the allocation received?" }), _jsx("input", { type: "date", value: formData.date_received, onChange: (e) => setFormData({
                                                            ...formData,
                                                            date_received: e.target.value,
                                                        }), disabled: formData.received !== "yes", className: "w-full border rounded-lg p-2 disabled:bg-gray-200 dark:bg-transparent dark:text-white" })] }), _jsx("br", {}), _jsxs(PrimaryButton, { type: "submit", children: [formData.id ? "Update" : "Add", " Allocation"] })] })] })), modalType === "cropActivity" && (_jsxs("div", { className: "p-10", children: [_jsx("h2", { className: "font-semibold text-xl mb-4 text-green-700 dark:text-green-600", children: formData.id
                                            ? "Edit Crop Activity"
                                            ...
                                            if (modalType === "cropActivity") {
                                                formData.id
                                                    ...
                                                    date: e.target.value,
                                                            ...
                                                            objectFit: "cover",
                                                            borderRadius: "10px",
                                                        } })] })), _jsxs(PrimaryButton, { type: "submit", className: "mt-4", children: [formData.id ? "Update" : "Add", " Crop Damage"] })] })] })), modalType === "damage" && (_jsxs("div", { className: "p-10", children: [_jsx("h2", { className: "font-semibold text-xl mb-4 dark:text-green-600 text-green-700", children: formData.id
                                            ? "Edit Crop Damage"
                                            ...
                                            if (modalType === "damage") {
                                                formData.id
                                                    ...
                                                    area_affected: e.target.value,
                                                            ...
                                                            objectFit: "cover",
                                                            borderRadius: "10px",
                                                        } })] })), _jsxs(PrimaryButton, { type: "submit", className: "mt-4", children: [formData.id ? "Update" : "Add", " Crop Damage"] })] })] })), modalType === "farm" && (_jsxs("div", { className: "p-10", children: [_jsx("h2", { className: "font-semibold text-xl mb-4 dark:text-green-600 text-green-700", children: formData.id ? "Edit Farm" : "Add Farm" }), _jsxs("form", { onSubmit: (e) => {
                                            e.preventDefault();
                                            if (modalType === "farm") {
                                                formData.id
                                                    ? handleUpdateFarm()
                                                ...
                                                }), placeholder: "Is the Person Owner?", className: "w-full mb-4 dark:bg-transparent dark:text-white" }), _jsxs(PrimaryButton, { type: "submit", children: [formData.id ? "Update" : "Add", " Farm"] })] })] }))] })] })] }));
}
