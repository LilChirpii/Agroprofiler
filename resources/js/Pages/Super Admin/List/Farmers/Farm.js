...
const Farm = ({ auth }) => {
    ...
    //  }, []);
    return (_jsxs(Authenticated, { user: auth.user, header: _jsx(_Fragment, { children: _jsx("div", { className: "flex w-full justify-between", children: _jsx("h2", { className: "text-[24px] mt-2 font-semibold text-green-600 leading-tight", children: "Farms Management" }) }) }), children: [_jsx(Head, { title: "Farms List" }), _jsx(ToastContainer, {}), _jsxs("div", { className: "flex gap-4", children: [_jsxs("div", { className: "flex gap-2", children: [_jsx(TextInput, { type: "file", accept: ".csv", onChange: handleImportFileChange, className: "rounded-md border p-1" }), _jsx(PrimaryButton, { onClick: handleUpload, children: "Import" })] }), _jsxs(PrimaryButton, { onClick: () => handleOpen(), children: [_jsx(Plus, { size: 24 }), "Add Data"] }), _jsxs(SecondaryButton, { onClick: handleMultipleDelete, disabled: selectedIds.length === 0 || loading, style: {
                            ...
                            border: "none",
                                ...
                                borderRadius: 2,
                                    ...
                                    }, value: farmers.find((farmer) => farmer.id === formData.farmer_id) || null, className: "dark:border-green-600", renderInput: (params) => (_jsx(TextField, { ...params, label: "Select Farmer", fullWidth: true, margin: "normal", className: "dark:border-green-600" })), renderOption: (props, option) => (_createElement(Box, { component: "li", ...props, key: option.id, onMouseEnter: (e) => {
