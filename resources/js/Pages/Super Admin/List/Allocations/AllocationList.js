...
import { Import, Pencil, Plus, Trash, Trash2, } from "lucide-react";
...
export default function AllocationList({ auth, allocation = {
    ...
    useEffect(() => {
        if (selectedAllocation?.allocation_type_id) {
            ...
            setSelectedAllocation((prev) => prev ? { ...prev, identifier_id: 0, funding_id: 0 } : prev);
        }
    ...
    return (_jsxs(Authenticated, { user: auth.user, header: _jsx(_Fragment, { children: _jsx("div", { className: "flex w-full justify-between", children: _jsx("h2", { className: "text-[25px] mt-2 font-semibold text-green-600 leading-tight", children: "Allocation Management" }) }) }), children: [_jsx(Head, { title: "Allocation Management" }), _jsx(ToastContainer, {}), _jsxs("div", { className: "flex gap-4", children: [_jsxs("div", { className: "flex gap-2", children: [_jsx(TextInput, { type: "file", onChange: handleFileChange, accept: ".xlsx,.csv", className: "rounded-md border p-1" }), _jsxs(PrimaryButton, { className: "flex gap-2 rounded-md", onClick: handleUpload, children: [_jsx(Import, { size: 16 }), "Import"] })] }), _jsxs(PrimaryButton, { onClick: openModal, children: [_jsx(Plus, { size: 24 }), "Add Allocation"] }), _jsxs(SecondaryButton, { onClick: handleMultipleDelete, disabled: selectedIds.length === 0 || loading, style: {
                            ...
                            gap: "8px",
                            ...
                            ) : (_jsxs("span", { className: "flex gap-2", children: [" ", _jsx(Trash2, { size: 14 }), " Delete"] })), loading ? (_jsxs("span", { className: "flex gap-2", children: [_jsx(Trash2, { size: 14 }), " Deleting"] })) : ("")] })] }), _jsx(Modal, { show: isModalOpen, onClose: closeModal, children: _jsxs("div", { className: "p-10", children: [_jsx("h2", { className: "text-xl mb-2 text-green-700 font-semibold", children: "Add New Allocation" }), _jsxs("form", { onSubmit: handleSubmit, children: [_jsxs("select", { name: "allocation_type_id", value: newAllocation.allocation_type_id, onChange: (e) => {
                                        const selectedAllocationType = allocationType.find((type) => type.value === e.target.value);
                                        setNewAllocation((prev) => ({
                                            ...prev,
                                    ...
                                    }, className: "mb-3 w-full rounded-lg border-gray-300", children: [_jsx("option", { value: "", children: "Allocation Type" }), allocationType.map((allocationType) => (_jsx("option", { value: allocationType.value, children: allocationType.label }, allocationType.value)))] }), _jsx(Select, { options: farmerss, isLoading: loadingFarmers, value: newAllocation.farmer_id
                                        ? farmerss.find((farmer) => farmer.value ===
                                            newAllocation.farmer_id) || null
                                        : null, onChange: (selectedOption) => handleSelectChange(selectedOption, "farmer_id"), placeholder: "Select Farmer" }), _jsxs("select", { name: "received", value: newAllocation.received, onChange: (e) => setNewAllocation((prev) => ({
                                        ...prev,
                                        received: e.target.value,
                                        date_received: e.target.value === "no"
                                            ? ""
                                            : prev.date_received,
                                    })), className: "mt-3 w-full rounded-lg border-gray-300", children: [_jsx("option", { value: "", disabled: true, children: "Received?" }), _jsx("option", { value: "yes", children: "Yes" }), _jsx("option", { value: "no", children: "No" })] }), loadingBalance ? (_jsx("p", { className: "text-gray-500", children: "Checking remaining balance..." })) : remainingBalance !== null ? (_jsxs("p", { className: `mt-2 ${remainingBalance > 0
                                        ? "text-green-500"
                                        ...
                                        ...prev,
                                        brgy_id: e.target.value,
                                    })), className: "mt-3 w-full rounded-lg border-gray-300", children: [_jsx("option", { value: "", children: "Select Barangay" }), filteredBarangays.map((barangay) => (_jsx("option", { value: barangay.id, children: barangay.name }, barangay.id)))] }), _jsxs("select", { name: "commodity_id", value: newAllocation.commodity_id, onChange: (e) => setNewAllocation((prev) => ({
                                        ...prev,
                                        commodity_id: e.target.value,
                                    })), className: "mt-3 w-full rounded-lg border-gray-300", children: [_jsx("option", { value: "", children: "Select Commodity" }), filteredCommodities.map((commodity) => (_jsx("option", { value: commodity.id, children: commodity.name }, commodity.id)))] }), _jsx(TextInput, { name: "funding_id", value: newAllocation.funding_name, placeholder: "Funding Name", className: "mt-3 w-full rounded-lg border-gray-300", disabled: true }), _jsx(TextInput, { type: "date", name: "date_received", value: newAllocation.date_received, onChange: (e) => setNewAllocation((prev) => ({
                                        ...prev,
                        ...
                        border: "none",
                                    ...
                                    }, className: "mb-3 w-full rounded-lg border-gray-300", children: [_jsx("option", { value: "", children: "Allocation Type" }), allocationType.map((allocationType) => (_jsx("option", { value: allocationType.value, children: allocationType.label }, allocationType.value)))] }), _jsx(Select, { options: farmerss, isLoading: loadingFarmers, value: selectedAllocation?.farmer_id
                                        ? farmerss.find((farmer) => farmer.value ===
                                        ...
                                        farmer_id: selectedOption
                                            ...
                                            : null,
                                    })), placeholder: "Select Farmer" }), _jsxs("select", { name: "received", value: selectedAllocation.received || "", onChange: (e) => setSelectedAllocation((prev) => ({
                                        ...prev,
                                        received: e.target.value,
                                        date_received: e.target.value === "no"
                                            ? ""
                                            : prev.date_received,
                                    })), className: "mt-3 w-full rounded-lg border-gray-300", children: [_jsx("option", { value: "", disabled: true, children: "Received?" }), _jsx("option", { value: "yes", children: "Yes" }), _jsx("option", { value: "no", children: "No" })] }), _jsx(TextInput, { type: "number", name: "amount", value: selectedAllocation.amount || "", onChange: (e) => setSelectedAllocation((prev) => ({
                                        ...prev,
                                        ...
                                        ...prev,
                                        brgy_id: e.target.value,
                                    })), className: "mt-3 w-full rounded-lg border-gray-300", children: [_jsx("option", { value: "", children: "Select Barangay" }), filteredBarangays.map((barangay) => (_jsx("option", { value: barangay.id, children: barangay.name }, barangay.id)))] }), _jsxs("select", { name: "commodity_id", value: selectedAllocation.commodity_id || "", onChange: (e) => setSelectedAllocation((prev) => ({
                                        ...prev,
                                        commodity_id: e.target.value,
                                    })), className: "mt-3 w-full rounded-lg border-gray-300", children: [_jsx("option", { value: "", children: "Select Commodity" }), filteredCommodities.map((commodity) => (_jsx("option", { value: commodity.id, children: commodity.name }, commodity.id)))] }), _jsx(TextInput, { name: "funding_id", value: selectedAllocation.funding_name || "", className: "mt-3 w-full rounded-lg border-gray-300", disabled: true }), _jsx(TextInput, { type: "date", name: "date_received", value: selectedAllocation.date_received || "", onChange: (e) => setSelectedAllocation((prev) => ({
                                        ...prev,
                                        date_received: e.target.value,
