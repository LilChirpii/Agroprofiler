...
const Commodities = ({ auth }) => {
    ...
    return (_jsxs(AdminLayout, { user: auth.user, header: _jsx(_Fragment, { children: _jsxs("div", { className: "flex w-full justify-between", children: [_jsx("h2", { className: "text-xl mt-2 font-medium text-green-800 leading-tight", children: "Category of Commodities Management" }), _jsxs("div", { className: "flex gap-2", children: [_jsxs(PrimaryButton, { onClick: () => handleOpen(), children: [_jsx(Plus, { size: 24 }), "Add Commodity"] }), _jsxs(SecondaryButton, { onClick: handleMultipleDelete, disabled: selectedIds.length === 0 || loading, style: {
                            ...
                            height: "550px",
                                ...
                                p: 4,
                                borderRadius: 2,
                            }, children: [_jsx("h2", { children: isEdit ? "Edit Commodity" : "Add Commodity" }), _jsx(TextField, { fullWidth: true, label: "Name", name: "name", value: formData.name, onChange: handleChange, margin: "normal" }), _jsx(TextField, { fullWidth: true, label: "Description", name: "desc", value: formData.desc, onChange: handleChange, margin: "normal" }), _jsx(Button, { variant: "contained", color: "primary", onClick: handleSave, style: { marginTop: 16 }, children: "Save" })] }) })] })] }));
};
