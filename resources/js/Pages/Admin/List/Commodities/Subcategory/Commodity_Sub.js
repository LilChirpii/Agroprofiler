...
import { Button, Modal, Box, TextField, Select, MenuItem, InputLabel, FormControl, } from "@mui/material";
...
const Commodities = ({ auth }) => {
    ...
    return (_jsxs(AdminLayout, { user: auth.user, header: _jsxs("div", { className: "flex w-full justify-between", children: [_jsx("h2", { className: "text-xl mt-2 font-medium text-green-800 leading-tight", children: "Commodities Management" }), _jsxs("div", { className: "flex gap-2", children: [_jsxs(PrimaryButton, { onClick: () => handleOpen(), children: [_jsx(Plus, { size: 24 }), "Add Commodity"] }), _jsxs(SecondaryButton, { onClick: handleMultipleDelete, disabled: selectedIds.length === 0 || loading, style: {
                            ...
                            height: "550px",
                                ...
                                border: "none",
                            }, getRowId: (row) => row.id }) }), _jsx(Modal, { open: open, onClose: handleClose, children: _jsxs(Box, { sx: {
                                position: "absolute",
                                top: "50%",
                                left: "50%",
                                ...
                                p: 4,
                                borderRadius: 2,
                            }, children: [_jsx("h2", { children: isEdit ? "Edit Commodity" : "Add Commodity" }), _jsx(TextField, { fullWidth: true, label: "Name", name: "name", value: formData.name, onChange: handleTextFieldChange, margin: "normal" }), _jsx(TextField, { fullWidth: true, label: "Description", name: "desc", value: formData.desc, onChange: handleTextFieldChange, margin: "normal" }), _jsxs(FormControl, { fullWidth: true, margin: "normal", children: [_jsx(InputLabel, { children: "Category" }), _jsxs(Select, { name: "commodity_category_id", value: formData.commodity_category_id || "", onChange: handleSelectChange, displayEmpty // Ensures the placeholder can be shown if the value is empty
                                            : true, children: [_jsx(MenuItem, { value: "", disabled: true, children: "Select a category" }), categories.map((category) => (_jsx(MenuItem, { value: category.id, children: category.name }, category.id)))] })] }), _jsx(Button, { variant: "contained", color: "primary", onClick: handleSave, style: { marginTop: 16 }, children: "Save" })] }) })] })] }));
};
