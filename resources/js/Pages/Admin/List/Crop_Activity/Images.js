...
export default function Images({ auth, images: initialImages, cropActivityId, }) {
    ...
    const handleFormSubmit = async (event) => {
        ...
        try {
            const response = await axios.post("/admin/cropactivity/images/store", formData);
