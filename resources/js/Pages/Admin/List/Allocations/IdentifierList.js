...
const IdentifierList = ({ auth }) => {
    ...
    return (_jsxs(AdminLayout, { user: auth.user, header: _jsx(_Fragment, { children: _jsxs("div", { className: "flex w-full justify-between", children: [_jsx("h2", { className: "text-[24px] mt-2 font-medium text-green-800 leading-tight", children: "Allocation Identifier Management" }), _jsxs("div", { className: "flex gap-2", children: [_jsxs(PrimaryButton, { onClick: () => handleOpen(), children: [_jsx(Plus, { size: 24 }), "Add Allocation Identifier"] }), _jsxs(SecondaryButton, { onClick: handleMultipleDelete, disabled: selectedIds.length === 0 || loading, style: {
                            ...
                            border: "none",
                        } }), _jsxs(Dialog, { open: open, onClose: handleClose, children: [_jsx(DialogTitle, { children: editMode ? "Edit Identifier" : "Add Identifier" }), _jsxs(DialogContent, { children: [_jsx(TextField, { margin: "dense", label: "Name", name: "title", fullWidth: true, value: formData.title, onChange: handleChange }), _jsx(TextField, { margin: "dense", label: "Description", name: "desc", fullWidth: true, value: formData.desc, onChange: handleChange })] }), _jsxs(DialogActions, { children: [_jsx(Button, { onClick: handleClose, children: "Cancel" }), _jsx(Button, { onClick: handleSubmit, variant: "contained", children: editMode ? "Update" : "Add" })] })] })] })] }));
};
