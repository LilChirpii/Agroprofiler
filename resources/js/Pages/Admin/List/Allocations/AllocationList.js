...
export default function AllocationList({ auth, allocation = {
    ...
    return (_jsxs(AdminLayout, { user: auth.user, header: _jsx(_Fragment, { children: _jsx("div", { className: "flex w-full justify-between", children: _jsx("h2", { className: "text-[24px] mt-2 font-medium text-green-800 leading-tight", children: "Allocation Management" }) }) }), children: [_jsx(Head, { title: "Allocation Management" }), _jsx(ToastContainer, {}), _jsxs("div", { className: "flex gap-4", children: [_jsxs("div", { className: "flex gap-2", children: [_jsx(TextInput, { type: "file", onChange: handleFileChange, accept: ".xlsx,.csv", className: "rounded-md border p-1" }), _jsxs(PrimaryButton, { className: "flex gap-2 rounded-md", onClick: handleUpload, children: [_jsx(Import, { size: 16 }), "Import"] })] }), _jsxs(PrimaryButton, { onClick: openModal, children: [_jsx(Plus, { size: 24 }), "Add Allocation"] }), _jsxs(SecondaryButton, { onClick: handleMultipleDelete, disabled: selectedIds.length === 0 || loading, style: {
