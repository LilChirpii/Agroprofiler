...
export default function AllocationTypeList({ auth }) {
    ...
    const rows = (allocationTypes || []).map((type, index) => ({
        ...
        commodities: Array.isArray(type.allocation_type_commodities) &&
            type.allocation_type_commodities.length > 0
            ? type.allocation_type_commodities
                .map((c) => c.commodity_name)
                .join(", ")
            : "Not Commodity Specific",
        barangays: Array.isArray(type.allocation_type_barangays) &&
        ...
        elligibilities: Array.isArray(type.allocation_type_elligibilities) &&
    ...
    return (_jsxs(AdminLayout, { user: auth.user, header: _jsx(_Fragment, { children: _jsxs("div", { className: "flex w-full justify-between", children: [_jsx("h2", { className: "text-[24px] mt-2 font-medium text-green-800 leading-tight", children: "Types of Allocation Management" }), _jsxs("div", { className: "flex gap-2", children: [_jsxs(PrimaryButton, { onClick: () => setModalOpen(true), children: [_jsx(Plus, { size: 24 }), "Add Allocation Type"] }), _jsxs(SecondaryButton, { onClick: handleMultipleDelete, disabled: selectedIds.length === 0 || loading, style: {
