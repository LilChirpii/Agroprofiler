...
import { Plus, Edit, Trash, ChevronLeft, TrashIcon, EditIcon, Cake, House, Phone, Accessibility, HandCoins, Pencil, } from "lucide-react";
...
export default function FarmProfile({ auth, farmer }) {
    ...
    const deleteData = async (id) => {
        ...
        try {
            ...
            toast.success(`${modalType.charAt(0).toUpperCase() + modalType.slice(1)} deleted successfully!`);
            fetchData();
        }
        catch (error) {
            console.error("Error deleting data:", error);
            toast.error(`Failed to delete ${modalType.charAt(0).toUpperCase() + modalType.slice(1)}!`);
        }
        finally {
            setLoading(false);
        }
    ...
    const allocationColumns = [
        ...
        },
        {
            ...
            headerName: "Actions",
            width: 150,
            renderCell: (params) => (_jsxs("div", { className: "flex justify-evenly mt-4", children: [_jsx(EditIcon, { size: 20, onClick: () => handleOpenModal("allocation", params.row), color: "green", className: "flex justify-center content-center" }), _jsx(TrashIcon, { size: 20, onClick: () => deleteData(params.row.id), color: "red" })] })),
        },
    ];
    const damageColumns = [
        { field: "id", headerName: "#", width: 90 },
        {
            ...
            renderCell: (params) => {
                const proofUrl = params.value
                    ...
                    : "";
                return proofUrl ? (_jsx("img", { src: proofUrl, alt: "Proof", style: {
                        width: "100%",
                        height: "auto",
                        padding: "5px",
                        borderRadius: "10px",
        ...
        },
        {
            ...
            align: "center",
            width: 150,
            renderCell: (params) => (_jsxs("div", { className: "flex justify-evenly mt-4", children: [_jsx(Edit, { size: 20, color: "green", onClick: () => handleOpenModal("damage", params.row) }), _jsx(Trash, { size: 20, color: "red", onClick: () => deleteData(params.row.id) })] })),
        },
    ];
    const farmColumns = [
        { field: "id", headerName: "#", width: 90 },
    ...
    const handleUpdateCropActivity = async () => {
        ...
        try {
            ...
            const response = await axios.post(`/cropactivity/update/${formData.id}`, dataToSend, { headers: { "Content-Type": "multipart/form-data" } });
    ...
    const handleUpdateFarm = async () => {
        ...
        try {
            ...
            console.error("Error updating Farm:", error.response?.data || error);
            toast.error(`Error updating farm: ${error.response?.data?.message || "Unknown error"}`);
        }
        finally {
            setLoading(false);
        }
    ...
    return (_jsxs(AdminLayout, { user: auth.user, children: [_jsx(Head, { title: `${farmer.firstname} ${farmer.lastname} ` }), _jsx(ToastContainer, {}), _jsxs("div", { className: "grid grid-cols-4 h-full gap-0 p-[0.5rem]", children: [_jsxs("div", { className: "relative left-0 h-full border-r px-4 py-2 border-slate-200 ", children: [_jsx("div", { children: _jsx("h2", { className: "text-xl mt-2 text-gray-800 leading-tight", children: _jsx(_Fragment, { children: _jsx("div", { className: "flex justify-between mb-4", children: _jsxs(Link, { href: "/farmers", children: [_jsxs("span", { className: "flex mb-4", children: [_jsx(ChevronLeft, { size: 24 }), " Back"] }), " "] }) }) }) }) }), _jsxs("div", { className: "flex content-center justify-center mt-10 font-semibold text-[24px] flex-wrap ", children: [farmer.firstname, " ", _jsx("br", {}), " ", farmer.lastname] }), _jsx("div", { className: "flex content-center justify-center mt-1", children: farmer.status === "registered" ? (_jsx(_Fragment, { children: _jsx("div", { className: "text-slate-600 p-1 rounded-2xl text-xs", children: farmer.rsbsa_ref_no }) })) : (_jsx(_Fragment, { children: _jsx("div", { className: "bg-red-600 p-1 px-2 text-white rounded-lg text-[10px]", children: "unregistered" }) })) }), _jsxs("div", { className: "mt-1", children: [_jsxs("div", { className: "mt-4", children: [_jsx("span", { className: "text-slate-400 text-sm ml-3 mt-4", children: "Info" }), " "] }), _jsxs("div", { className: "pl-3", children: [_jsx("div", { className: "mt-2 flex gap-1", children: _jsxs("span", { className: "flex gap-2 text-slate-700 text-sm", children: [_jsx(House, { size: 18 }), farmer.barangay?.name, ", Davao del Sur"] }) }), _jsx("div", { className: "mt-2", children: _jsxs("span", { className: "flex gap-2 text-slate-700 text-sm", children: [_jsx(Cake, { size: 18 }), farmer.dob] }) }), _jsx("div", { className: "mt-2", children: _jsxs("span", { className: "flex gap-2 text-slate-700 text-sm", children: [_jsx(Phone, { size: 18 }), "09676979568"] }) }), farmer["4ps"] === "yes" ? (_jsx(_Fragment, { children: _jsx("div", { className: "mt-2", children: _jsxs("span", { className: "flex gap-2 text-slate-700 text-sm", children: [_jsx(HandCoins, { size: 20 }), "4ps Beneficiary"] }) }) })) : (""), farmer.pwd === "yes" ? (_jsx(_Fragment, { children: _jsx("div", { className: "mt-2", children: _jsxs("span", { className: "flex gap-2 text-slate-700 text-sm", children: [_jsx(Accessibility, { size: 20 }), "Person with disabilty"] }) }) })) : ("")] })] })] }), _jsxs("div", { className: "relative col-span-3 right-0 h-full px-6 py-4", children: [_jsx("span", { className: "text-lg text-slate-700 font-semibold", children: "Data History" }), _jsx("div", { className: "w-full h-full mt-4", children: _jsxs(Tabs, { children: [_jsxs(Tab, { label: "Allocation", children: [_jsx("div", { className: "flex justify-end px-4", children: _jsx(Button, { className: "bg-green-800 text-white mb-4 p-2 px-2 rounded-lg hover:bg-green-900 hover:shadow-md ", onClick: () => handleOpenModal("allocation"), children: _jsxs("span", { className: "text-sm flex gap-2", children: [_jsx(Plus, { size: 18 }), "Add Allocation"] }) }) }), _jsx(Timeline, { items: allocations.map((allocation) => ({
                                                        id: allocation.id,
                                                        fields: {
                                                            ...
                                                            commodity: allocation.commodity?.name,
                                                        ...
                                                        },
                                                        {
                                                            ...
                                                            borderRadius: "10px",
                                                            height: "450px",
                                                        } }) })] }), _jsxs(Tab, { label: "Crop Activities", children: [_jsx("div", { className: "flex justify-end px-4", children: _jsx(Button, { className: "bg-green-800 text-white mb-4 p-2 rounded", onClick: () => handleOpenModal("cropActivity"), children: _jsxs("span", { className: "text-sm flex gap-2", children: [_jsx(Plus, { size: 18 }), "Add Crop Activity"] }) }) }), _jsx(Timeline, { items: cropActivities.map((cropActivity) => ({
                                                        id: cropActivity.id,
                                                        fields: {
                                                        ...
                                                        { key: "img", label: "File" },
                                                        { key: "date", label: "Date" },
                                                    ] })] })] }) })] }), _jsxs(Modal, { show: modalOpen, onClose: () => setModalOpen(false), children: [modalType === "allocation" && (_jsxs("div", { className: "p-10 h-50", children: [_jsx("h2", { className: "font-semibold text-lg mb-2 text-[20px] text-green-800", children: formData.id
                                            ? "Edit Allocation"
                                            ...
                                            if (modalType === "allocation") {
                                                formData.id
                                                    ...
                                                    : handleSaveAllocation();
                                                            ...
                                                            formData.allocation_type_id), onChange: handleAllocationTypeChange, placeholder: "Select Allocation Type", className: "mb-4 " }), _jsx(TextInput, { type: "text", value: allocationType.find((type) => type.value ===
                                                            ...
                                                            formData.commodity_id), onChange: (selectedOption) => handleSelectChange(selectedOption, "commodity_id"), placeholder: "Select Commodity", className: " mb-4" }), _jsx(Select, { options: barangays, isLoading: loadingBarangays, value: barangays.find((barangay) => barangay.value ===
                                                            formData.barangay_id), onChange: (selectedOption) => handleSelectChange(selectedOption, "barangay_id"), placeholder: "Select Barangay", className: "rounded-2xl mb-4" }), _jsx(TextInput, { type: "number", name: "amount", value: formData.amount || "", onChange: (e) => setFormData({
                                                            ...formData,
                                                            amount: parseFloat(e.target.value) || 0,
                                                        }), placeholder: "Amount", className: "w-full rounded-md" }), _jsxs("p", { className: "text-sm text-gray-500 px-4", children: ["Remaining Balance: ", remainingAmount] }), _jsx("label", { className: "block mt-4 font-semibold px-4 text-[15px]", children: "Was the Allocation Received?" }), _jsxs("select", { value: formData.received, onChange: (e) => setFormData({
                                                            ...formData,
                                                            received: e.target.value,
                                                            date_received: e.target.value === "Yes"
                                                                ? formData.date_received
                                                                : "",
                                                        }), className: "w-full border rounded-md border-slate-400 p-2", children: [_jsx("option", { value: "no", children: "No" }), _jsx("option", { value: "yes", children: "Yes" })] }), _jsx("label", { className: "block mt-4 font-semibold px-4 text-[15px]", children: "If yes, when was the allocation received?" }), _jsx("input", { type: "date", value: formData.date_received, onChange: (e) => setFormData({
                                                            ...formData,
                                                            date_received: e.target.value,
                                                        }), disabled: formData.received !== "yes", className: "w-full border rounded-lg p-2 disabled:bg-gray-200" })] }), _jsx("br", {}), _jsxs(PrimaryButton, { type: "submit", children: [formData.id ? "Update" : "Add", " Allocation"] })] })] })), modalType === "cropActivity" && (_jsxs("div", { className: "p-10", children: [_jsx("h2", { className: "font-semibold text-xl mb-4 text-green-700", children: formData.id
                                            ? "Edit Crop Activity"
                                            ...
                                            if (modalType === "cropActivity") {
                                                formData.id
                                                    ...
                                                    ...formData,
                                                    date: e.target.value,
                                                }), placeholder: "Date", className: "w-full mt-4 mb-4" }), _jsxs("div", { children: [_jsx("label", { htmlFor: "file_path", className: "block mb-2", children: "Upload Image:" }), _jsx(TextInput, { type: "file", id: "proof", name: "file_path", accept: "image/*", onChange: (e) => {
                                                        ...
                                                        }, className: "w-full" })] }), formData.imagePreview && (_jsxs("div", { className: "mt-4", children: [_jsx("label", { className: "block mb-2", children: "Image Preview:" }), _jsx("img", { src: formData.imagePreview, alt: "Preview", className: "rounded border", style: {
                                                            maxWidth: "100px",
                                                            height: "100px",
                                                            objectFit: "cover",
                                                            borderRadius: "10px",
                                                        } })] })), _jsxs(PrimaryButton, { type: "submit", className: "mt-4", children: [formData.id ? "Update" : "Add", " Crop Damage"] })] })] })), modalType === "damage" && (_jsxs("div", { className: "p-10", children: [_jsx("h2", { className: "font-semibold text-xl mb-4 text-green-700", children: formData.id
                                            ? "Edit Crop Damage"
                                            ...
                                            if (modalType === "damage") {
                                                formData.id
                                                ...
                                                }, placeholder: "Select Farm", className: "rounded-2xl mb-4" }), _jsx(Select, { options: commodities, isLoading: loadingCommodities, value: commodities.find((commodity) => commodity.value ===
                                                    formData.commodity_id), isDisabled: true, placeholder: "Commodity (Auto-filled)", className: "rounded-2xl mb-4" }), _jsx(Select, { options: barangays, isLoading: loadingBarangays, value: barangays.find((barangay) => barangay.value === formData.brgy_id), isDisabled: true, placeholder: "Barangay (Auto-filled)", className: "rounded-2xl mb-4" }), _jsx(Select, { options: cropDamageCause, isLoading: loadingCropDamageCause, value: cropDamageCause.find((cause) => cause.value ===
                                                    formData.cropDamageCause_id), onChange: (selectedOption) => handleSelectChange(selectedOption, "crop_damage_cause_id"), placeholder: "Select Cause Type", className: "rounded-2xl mb-4" }), _jsx(TextInput, { type: "number", name: "total_damaged_area", value: formData.total_damaged_area || "", onChange: (e) => {
                                                    const totalDamagedArea = Number(e.target.value);
                                                    const selectedFarm = farms.find((farm) => farm.id === formData.farm_id);
                                                    const farmArea = parseFloat(selectedFarm?.ha) || 1;
                                                    let severity = "low";
                                                ...
                                                }, placeholder: "Total Damaged Area", className: "w-full mb-4" }), _jsx(TextInput, { type: "number", name: "partially_damaged_area", value: formData.partially_damaged_area || "", onChange: (e) => setFormData({
                                                    ...formData,
                                                    ...
                                                    area_affected: e.target.value,
                                                        ...
                                                        }, className: "w-full" })] }), formData.imagePreview && (_jsxs("div", { className: "mt-4", children: [_jsx("label", { className: "block mb-2 font-semibold text-[15px]", children: "Image Preview:" }), _jsx("img", { src: formData.imagePreview, alt: "Preview", className: "rounded border", style: {
                                                            maxWidth: "100px",
                                                            height: "100px",
                                                            objectFit: "cover",
                                                            borderRadius: "10px",
                                                        } })] })), _jsxs(PrimaryButton, { type: "submit", className: "mt-4", children: [formData.id ? "Update" : "Add", " Crop Damage"] })] })] })), modalType === "farm" && (_jsxs("div", { className: "p-10", children: [_jsx("h2", { className: "font-semibold text-xl mb-4 text-green-700", children: formData.id ? "Edit Farm" : "Add Farm" }), _jsxs("form", { onSubmit: (e) => {
                                            e.preventDefault();
                                            if (modalType === "farm") {
                                                formData.id
                                                    ? handleUpdateFarm()
                                                ...
                                                }), placeholder: "Is the Person Owner?", className: "w-full mb-4" }), _jsxs(PrimaryButton, { type: "submit", children: [formData.id ? "Update" : "Add", " Farm"] })] })] }))] })] })] }));
}
