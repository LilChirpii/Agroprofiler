...
Route::middleware(['auth', 'super admin'])->group(function () {
    ...
    Route::delete('/commodity-categories/destroy/{commodity}', [CommodityCategoryController::class, 'destroy']);
    ...
    Route::delete('/crop-damages/destroy/{id}', [CropDamagesController::class, 'destroy'])->name('crop.damages.destroy');
    Route::post('/cropdamages/store', [CropDamagesController::class, 'store'])->name('crop.damages.store');
     Route::put('/cropdamages/update/{id}', [CropDamagesController::class, 'update'])->name('crop.damages.update');
   ...
   //cropactivity
    ...
    Route::put('/cropactivity/image/update/{id}', [ImagesController::class, 'update'])->name('crop.images.activity.update');
