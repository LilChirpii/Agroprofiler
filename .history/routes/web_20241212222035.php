...
Route::middleware(['auth', 'admin'])->group(function(){
    ...
    //dashboard
    Route::get('/admin/barangays/admin/data', [AllocationController::class, 'showBarangays']);
    Route::get('/admin/allocations/admin/data', [AllocationController::class, 'showAllocations']);
    ...
    //allocation type
    Route::get('/admin/allocation/allocationtype', [AllocationTypeController::class, 'admin'])->name('admin.allocation.type.index');
    ...
    //Farmers
    Route::get('/admin/farmers', [FarmerController::class, 'adminIndex'])->name('admin.farmers.index');
    Route::post('/admin/farmers/store', [FarmerController::class, 'store']);
    ...
    Route::delete('/admin/farmers/destroy/{id}', [FarmerController::class, 'destroy']);
    ...
    //allocations
    Route::get('/admin/allocations', [AllocationController::class, 'admin'])->name('admin.allocations.index');
   ...
   //cropactivity
    ...
    Route::patch('/admin/cropactivity/update/{id}', [CropActivityController::class, 'update'])->name('admin.crop.activity.update');
    Route::post('/admin/cropactivity/store', [CropActivityController::class, 'store'])->name('admin.crop.activity.store');
    Route::delete('/admin/cropactivity/destroy/{id}', [CropActivityController::class, 'adminDestroy'])->name('admin.crop.activity.destroy');
    ...
    Route::get('/admin/recommendations', [RecommendationController::class, 'index'])->name('admin.recommendations.index');
    ...
    Route::get('/admin/allocation-types-list', [AllocationTypeController::class, 'show']);
    ...
    Route::get('/admin/crop-damages-ui', [CropDamageCauseController::class, 'show'])->name('admin.crop.damage.show');
    ...
    Route::get('/admin/farmers/data', [FarmerController::class, 'showFarmers']);
