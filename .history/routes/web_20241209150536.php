...
Route::middleware(['auth', 'super admin'])->group(function () {
    ...
    Route::get('/commodity-categories', [CommodityController::class, 'index']);
    Route::post('/commodity-categories', [CommodityController::class, 'store']);
    Route::put('/commodity-categories/{commodity}', [CommodityController::class, 'update']);
    Route::delete('/commodity-categories/{commodity}', [CommodityController::class, 'destroy']);
