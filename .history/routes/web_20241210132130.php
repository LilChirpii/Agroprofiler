...
Route::middleware(['auth', 'super admin'])->group(function () {
    ...
    //commodity category
    Route::get('/commodity-categories-show', [CommodityCategoryController::class, 'showCommodityCategory'])->name('commodity.category.index'); Route::get('/commodity-categories', [CommodityCategoryController::class, 'index'])->name('commodity.index'); Route::post('/commodity-categories/store', [CommodityCategoryController::class, 'store']); Route::put('/commodities/update/{id}', [CommodityController::class, 'update']); Route::delete('/commodity-categories/destroy/{commodity}', [CommodityCategoryController::class, 'destroy']);
