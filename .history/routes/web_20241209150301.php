...
Route::middleware(['auth', 'super admin'])->group(function () {
    ...
    oute::get('/commodity-categories', [CommodityCategoryController::class, 'index']);
Route::post('/commodity-categories', [CommodityCategoryController::class, 'store']);
Route::put('/commodity-categories/{commodityCategory}', [CommodityCategoryController::class, 'update']);
Route::delete('/commodity-categories/{commodityCategory}', [CommodityCategoryController::class, 'destroy']);
