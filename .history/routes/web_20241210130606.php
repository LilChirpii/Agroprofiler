...
Route::middleware(['auth', 'super admin'])->group(function () {
    ...
    //commodity category
    Route::put('/commodity-categories-show', [CommodityCategoryController::class, 'showCommodityCategory'])->name('commodity.category.index');
    ...
    Route::put('/commodity-categories/update/{commodity}', [CommodityCategoryController::class, 'update']);
