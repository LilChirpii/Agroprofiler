...
Route::middleware(['auth', 'super admin'])->group(function () {
   ...
   //cropactivity
    ...
    Route::put('/crop-damage-causes/upadte/{id}', [CropDamageCauseController::class, 'update']);
    Route::delete('/crop-damage-causes/destroy/{cropDamageCause}', [CropDamageCauseController::class, 'destroy']);
