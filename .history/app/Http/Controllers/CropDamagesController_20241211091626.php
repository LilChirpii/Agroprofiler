...
{
    // Check if the CropDamage record exists
    ...
    $validator = Validator::make($request->all(), [
        ...
        'cause' => 'required|string|max:255',
        'remarks' => 'nullable|string|max:255',
        'proof' => 'required|image|mimes:jpeg,png,jpg,gif,svg|max:2048', // validation for image file
    ]);
    ...
    // Handle file upload if there's a new proof file
    ...
    // Update the crop damage record with the new data
