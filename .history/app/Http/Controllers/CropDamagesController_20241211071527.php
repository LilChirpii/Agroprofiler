...
class CropDamagesController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // return redirect()->route('crop.damages.index')->with('success', 'Crop damage record created successfully.');return response()->json(['message' => 'Crop damage data stored successfully.']);
    }
