...
class DashboardController extends Controller
{
    ...
    public function commodityCounts(){
        $commodityCounts = CommodityCategory::select('commodity_category_id', DB::raw('count(*) as count'))
        ->groupBy('commodity_category_id')
        ->get();

        $data = $commodityCounts->map(function ($commodity) {
            return [
                'name' => CommodityCategory::find($commodity->commodity_category_id)->name,
