...
type HeatmapData = {
    [barangay: string]: {
        ...
        commodities_categories?: { [subtype: string]: number };
                ...
                <Card title="Barangay Data Distribution">
                    <>
                        <div className="p-5">
                            ...
                            {/* Dynamically render the subcategories select box based on the selected distribution type */}
                            ...
                            {distributionType === "highValue" && (
                                <select
                                    className="rounded-2xl mb-5"
                                    onChange={(e) =>
                                        console.log(
                                            "High Value Crop Selected:",
                                            e.target.value
                                        )
                                    }
                                >
                                    <option value="">
                                        Select High Value Crop
                                    </option>
                                    {commodityCategories.map((category) =>
                                        category.commodities.map(
                                            (commodity) => (
