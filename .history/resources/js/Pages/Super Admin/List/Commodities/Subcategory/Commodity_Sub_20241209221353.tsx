...
interface Commodity extends PageProps {
    id: number;
    name: string;
    desc: string;
...
const Commodities = ({ auth }: CommodityProps) => {
    ...
    const fetchCommodities = async () => {
        ...
        try {
            ...
            console.log("fetch commmodites: ", commodities);
        } catch (error) {
    ...
    const handleSave = async () => {
        try {
            if (isEdit) {
                ...
                await axios.post("/commodities/store", formData);
                fetchCommodities();
                setCommodities((prevData: CommodityProps = []) =>
                    prevData.filter((commodity) => commodity.id !== formData.id)
                );
    ...
    const handleDelete = async (id: number) => {
        try {
            ...
            setCommodities((prevData = []) =>
                prevData.filter((commodities) => commodities !== commodities)
            );
