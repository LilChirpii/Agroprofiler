...
export default function CropDamagesList({
    ...
    const rows = damageData.map((damage: Damage) => ({
        ...
        cause: damage.cropDamageCause?.name,
    ...
    const handleEdit = (cropDamageId: number) => {
        ...
        if (cropDamage) {
            setSelectedDamage(cropDamage);
            setIsUpdateModalOpen(true);
            console.log("Selected cropDamage: ", cropDamage);
        } else {
    ...
    const handleUpdate = async (e: React.FormEvent) => {
        ...
        const updates = {
            ...
            cause: selectedDamage.cropDamageCause?.id,
