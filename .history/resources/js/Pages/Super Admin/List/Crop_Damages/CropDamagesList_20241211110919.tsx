...
const CropDamages = ({ auth }: PageProps) => {
    ...
    const handleDelete = async (id: number) => {
        try {
            // Prepare the CSRF token and headers
            const csrfToken =
                document
            ...
            const headers = {
                "Content-Type": "multipart/form-data", // In case you're uploading files
                "X-CSRF-TOKEN": csrfToken, // Include CSRF token
            };

            // Send the DELETE request with the CSRF token and correct headers
            await axios.delete(`/cropdamages/destroy/${id}`, { headers });
