        ...
        try {
            if (formData.id) {
                ...
                const response = await axios.post(
                    "/store/cropdamages", // Adjust this path if needed
                    formData
                );
            ...
            <div>
                ...
                <Dialog open={openDialog} onClose={() => setOpenDialog(false)}>
                    ...
                    <DialogActions>
                        ...
                        <PrimaryButton type="button" onClick={handleSubmit}>Submit</PrimaryButton type="button">
                    </DialogActions>
                </Dialog>
            </div>
        </Authenticated>
