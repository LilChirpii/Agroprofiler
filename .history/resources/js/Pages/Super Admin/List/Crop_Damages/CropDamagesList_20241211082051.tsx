...
const CropDamages = ({ auth }: PageProps) => {
    ...
    const handleSubmit = async (event: React.FormEvent) => {
        ...
        try {
            ...
            let response;
            // Check if the form data already has an 'id', which means we're updating an existing record
            if (formData.id) {
                // PUT request to update the crop damage
                ...
                // POST request to create a new crop damage record
            ...
            // After successful response, fetch crop damages again
            fetchCropDamages();
