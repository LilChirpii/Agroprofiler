...
export default function AllocationList({
    ...
    const handleEdit = (id: number) => {
        // Find the selected allocation based on the id
        const allocationToEdit = allocationTypes.find(
            (type) => type.allocation_type_id === id
        );
        if (allocationToEdit) {
            setSelectedAllocation(allocationToEdit);
