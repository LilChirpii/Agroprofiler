...
export default function AllocationList({
    ...
    const handleUpdateSelectChange = (selectedOption: any, name: string) => {
        setSelectedAllocation((prevAllocation) => {
            ...
            const updatedAllocation = { ...prevAllocation };

            if (name === "farmer_id") {
                updatedAllocation.farmer = selectedOption
                    ? {
                    ...
                    : null;
            } else if (name === "brgy_id") {
                updatedAllocation.barangay = selectedOption
                    ? { id: selectedOption.value, name: selectedOption.label }
                    : null;
            } else {
                updatedAllocation[name] = selectedOption
