...
export default function AllocationTypeList({ auth }: PageProps) {
    ...
    const fetchData = async () => {
        ...
        try {
            ...
            const allocationTypeResponse = await axios.get<AllocationTypeRow[]>(
            ...
            setAllocationTypes(allocationTypeResponse.data);
            console.log("crop damages: ", allocationTypes);
        } catch (error) {
    ...
    const rows: AllocationTypeRow[] = (allocationTypes || []).map((type) => ({
        ...
        crop_damage_causes: Array.isArray(type.crop_damage_causes)
            ? type.crop_damage_causes
    ...
    const columns: GridColDef[] = [
        { field: "allocation_type", headerName: "Name", flex: 2 },
        ...
        >
            ...
            <div className="p-6 bg-white border-b border-gray-200">
                <PrimaryButton onClick={() => setModalOpen(true)}>
                    <Plus size={24} /> Add Allocation Type
                </PrimaryButton>
