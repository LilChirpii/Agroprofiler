...
export default function AllocationTypeList({ auth }: PageProps) {
    ...
    const transformedData: AllocationTypeRow[] = allocationTypes.map(
        (item) => ({
            allocation_type_id: item.allocation_type_id,
            allocation_type_name: item.allocation_type_name,
            allocation_type_description: item.allocation_type_description,
            allocation_type_commodities: item.allocation_type_commodities,
            allocation_type_barangays: item.allocation_type_barangays,
            allocation_type_crop_damage_causes:
                item.allocation_type_crop_damage_causes,
            allocation_type_elligibilities: item.allocation_type_elligibilities,
        })
    );

    const rows: AllocationTypeRow[] = transformedData;
            ...
            <div className="p-6 bg-white border-b border-gray-200">
                ...
                >
                    <DataGrid
                        ...
                        getRowId={(row) => row.allocation_type_id}
