...
export default function AllocationTypeList({ auth }: PageProps) {
    ...
    const handleUpdateSubmit = async () => {
        ...
        const payload = {
            ...
            name: formData.name,
            desc: formData.desc,
            commodityIds: formData.commodityIds, // Include selected commodities
            barangayIds: formData.barangayIds, // Include selected barangays
            cropDamageCauseIds: formData.cropDamageCauseIds, // Include selected crop damage causes
            eligibilityIds: formData.eligibilityIds, // Include selected eligibilities
        };
