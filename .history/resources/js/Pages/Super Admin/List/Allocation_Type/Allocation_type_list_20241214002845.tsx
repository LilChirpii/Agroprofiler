                            ...
                            >
                                    ...
                                    <Checkbox
                                        ...
                                        onChange={() => {
                                            if (
                                                ...
                                                // Uncheck "NO" and clear the commodity values
                                                setFormData((prevState) => ({
                                                    ...prevState,
                                                    commodityIds: [],
                                                }));
                                            } else {
                                                // Select "NO" and clear other commodities
                                                setFormData((prevState) => ({
                                                    ...prevState,
                                                    commodityIds: [0],
                                                }));
                                ...
                                {commodities.map((commodity) => (
                                    <MenuItem
                                        key={commodity.id}
                                        value={commodity.id}
                                        disabled={formData.commodityIds.includes(
                                            0
                                        )} // Disable if "NO" is selected
                                    >
                                        <Checkbox
                                            checked={formData.commodityIds.includes(
                                                commodity.id
                            ...
                            >
                                <MenuItem value={0}>
                                    <Checkbox
                                        ...
                                        onChange={() => {
                                            if (
                                                formData.barangayIds.includes(0)
                                            ) {
                                                setFormData((prevState) => ({
                                                    ...prevState,
                                                    barangayIds: [],
                                ...
                                {barangays.map((barangay) => (
                                    <MenuItem
                                        key={barangay.id}
                                        value={barangay.id}
                                        disabled={formData.barangayIds.includes(
                                            0
                                        )} // Disable if "NO" is selected
                                    >
                                        <Checkbox
                            ...
                            >
                                <MenuItem value={0}>
                                    <Checkbox
                                        ...
                                        onChange={() => {
                                            if (
                                                formData.cropDamageCauseIds.includes(
                                                    0
                                                )
                                            ) {
                                                setFormData((prevState) => ({
                                ...
                                {cropDamages.map((damage) => (
                                    <MenuItem
                                        key={damage.id}
                                        value={damage.id}
                                        disabled={formData.cropDamageCauseIds.includes(
                                            0
                                        )} // Disable if "NO" is selected
                                    >
                                        <Checkbox
                            ...
                            >
                                <MenuItem value="all">
                                    <Checkbox
                                        ...
                                        onChange={() => {
                                            // Toggle logic for "All" checkbox
                                            setFormData((prevState) => ({
                                                ...prevState,
                                                eligibilityIds:
                                                    prevState.eligibilityIds
                                                        .length ===
                                                    eligibilities.length
                                                        ? [] // If all are selected, uncheck "All" and clear
                                                        : eligibilities.map(
                                                              (e) => e.id
                                                          ), // If not all selected, check "All"
                                            }));
                                        }}
                                    />
