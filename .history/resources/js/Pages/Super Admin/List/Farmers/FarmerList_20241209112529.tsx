...
export default function FarmerList({
    ...
    const [filteredRows, setFilteredRows] = useState<Farmer[]>(farmer || []);

const handleSearch = (query: string) => {
    const lowerCaseQuery = query.toLowerCase();
    if (!farmer) return; // Ensure `farmer` is defined before filtering

    const filteredData = farmer.filter((farmer) =>
