                        ...
                        <form onSubmit={handleUpdate}>
                            ...
                            <div className="flex gap-4">
                                ...
                                <div>
                                    ...
                                    <select
    name="brgy_id"
    value={selectedFarmer.barangay?.id || ""}  {/* Use the barangay id */}
    onChange={(e) => {
        const barangayId = Number(e.target.value);
        const selectedBarangay = barangays.find((b) => b.id === barangayId);
        setSelectedFarmer({
            ...selectedFarmer,
            barangay: selectedBarangay || { id: 0, name: "Unknown" }, // Fallback to a default barangay if not found
            brgy_id: barangayId, // Ensure brgy_id is updated as well
        });
    }}
    className="mt-3 w-full rounded-lg border-gray-300"
>
