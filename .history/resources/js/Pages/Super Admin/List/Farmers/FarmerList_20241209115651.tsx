...
export default function FarmerList({
    ...
    const fetchFarmerData = () => {
        ...
        axios
            ...
            .then((response) => {
                ...
                setFarmersData(data);
                console.log("Farmersss data: ", farmers);
            })
            .catch((error) => {
    ...
    const columns: GridColDef[] = [
        ...
        { field: "age", headerName: "Age", width: 90 },
        {
            ...
            headerName: "Barangay",
            width: 100,
            valueGetter: (params: { farmersData: Farmer }) => {
                console.log(params.farmersData);
                return params.farmersData?.barangay?.name || "Not Assigned";
            },
        },
