                        ...
                        <div className="p-10 h-50">
                            ...
                            >
                                <input
                                    type="hidden"
                                    name="brgy_id"
                                    value={formData.farmer?.brgy_id || ""}
                                    // No need to modify brgy_id here if it's set from formData.farmer
                                    onChange={(e) =>
                                        setFormData({
                                            ...formData,
                                            farmer: {
                                ...
                                <input
                                    ...
                                    onChange={(e) =>
                                        setFormData({
                                            ...
                                            farmer: {
                                                ...formData.farmer,
                                                farmer_d: e.target.value,
                                            },
                                        })
                                    } // Keep the farmer_id static from formData
                                />
