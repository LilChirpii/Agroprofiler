        ...
        >
            ...
            <div className="p-4">
                <Card title="Details">
                    <div className="flex gap-4 mb-2">
                        <User2Icon size={24} /> {farmer.firstname}{" "}
                        {farmer.lastname}
                    </div>
                    <div className="flex gap-2">
                        <HouseIcon size={24} /> {farmer.barangay?.name}, Davao
                        del Sur
                    </div>
                </Card>
            </div>
            <div>
                <div className="flex justify-between mb-4 mt-5">
                    <h1 className="text-md mt-5">Allocations Received</h1>
                    <PrimaryButton
                ...
                <div
                    style={{ height: 400, width: "80%", alignItems: "center" }}
                >
                    <DataGrid
                ...
                <div className="">
                    <div className="flex justify-between">
                        <h1 className="mt-5 text-xl">Crop Damages History</h1>
                        <PrimaryButton
                            className="bg-green-500 text-white px-4 py-2 rounded flex"
