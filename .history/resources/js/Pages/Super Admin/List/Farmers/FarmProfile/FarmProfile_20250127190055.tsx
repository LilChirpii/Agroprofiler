    ...
    return (
        ...
        >
            ...
            <div className="grid grid-cols-4 h-full gap-0 p-[0.5rem]">
                <div className="relative left-0 h-full border-r-1 border-black">
                    <div className="relative w-full  flex justify-center content-center block ">
                        <img
                            src="https://www.pngmart.com/files/22/User-Avatar-Profile-PNG.png"
                            alt=""
                            className="absolute w-[105px] h-[105px] object-cover rounded-lg border"
                        />
                    </div>
                    <div>{farmer.firstname}</div>
                </div>
                <div className="relative col-span-3 right-0 h-full ">
                    hkdahsdkaj
                </div>
            </div>
        </Authenticated>
