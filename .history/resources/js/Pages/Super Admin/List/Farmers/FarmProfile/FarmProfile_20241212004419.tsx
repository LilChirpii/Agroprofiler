...
export default function FarmProfile({ auth, farmer }: FarmersListProps) {
    ...
    return (
        ...
        e.preventDefault();
        if (modalType === "allocation") {
            formData.id ? handleUpdateAllocation() : handleSaveAllocation();
        } else if (modalType === "damage") {
            formData.id ? handleUpdateCropDamage() : handleSaveCropDamage();
        } else if (modalType === "farm") {
            formData.id ? handleUpdateFarm() : handleSaveFarm();
        }
    }}
                                <Select
