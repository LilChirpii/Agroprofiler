...
export default function FarmProfile({ auth, farmer }: FarmersListProps) {
    ...
    const handleUpdateFarm = async () => {
        ...
        try {
            ...
            dataToSend.append("farmer_id", farmer.id.toString());
            dataToSend.append("brgy_id", formData.brgy_id.toString());
            dataToSend.append("commodity_id", formData.commodity_id.toString());
            dataToSend.append("ha", formData.ha.toString());
            dataToSend.append("owner", formData.owner);
            ...
            const response = await axios.post(
                `/farms/update/${formData.id}`, // Use POST if server requires method spoofing
                dataToSend,
                { headers: { "Content-Type": "multipart/form-data" } }
            );
    ...
    return (
        ...
        >
            ...
            <ToastContainer />
            <div className="p-10">
                <Card title="Details" className="px-10 pt-5">
