...
export default function FarmProfile({ auth, farmer }: FarmersListProps) {
    ...
    const handleSelectChange = (selectedOption: any, field: string) => {
        setFormData((prevState: any) => {
            // Check modal type and update form data accordingly
            if (modalType === "farm") {
                // Handle the farm form
                return {
                    ...prevState,
                    farm: {
                        ...prevState.farm,
                        [field]: selectedOption ? selectedOption.value : "", // farm-specific data
                    },
                };
            }
            if (modalType === "allocation") {
                // Handle the allocation form
                return {
                    ...prevState,
                    allocation: {
                        ...prevState.allocation,
                        [field]: selectedOption ? selectedOption.value : "", // allocation-specific data
                    },
                };
            }
            if (modalType === "commodity") {
                // Handle the commodity form
                return {
                    ...prevState,
                    commodity: {
                        ...prevState.commodity,
                        [field]: selectedOption ? selectedOption.value : "", // commodity-specific data
                    },
                };
            }
            // Default case if no modal type matches
            return {
                ...prevState,
