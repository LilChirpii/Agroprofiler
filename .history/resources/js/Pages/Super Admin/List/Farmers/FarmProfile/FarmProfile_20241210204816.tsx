                        ...
                        <div className="p-10 h-50">
                            ...
                            >
                                <input
                                    type="text"
                                    name="brgy_id"
                                    value={farmer?.barangay?.id || ""} // Assuming `farmer` object has a `barangay` nested object
                                    readOnly
                                    onChange={(e) =>
                                        setFormData({
                                            ...formData,
                                            farmer: {
                                                ...formData.farmer,
                                                brgy_id: e.target.value, // Update the brgy_id field in farmer object
                                            },
                                        })
                                    }
                                />
                                ...
                                <input
                                    type="text"
                                    name="farmer_id"
                                    value={farmer?.id || ""} // Assuming `farmer` object has an `id` field
                                    readOnly
                                    onChange={(e) =>
                                        setFormData({
                                            ...formData,
                                            farmer: {
                                                ...formData.farmer,
                                                id: e.target.value, // Update the id field in farmer object
                                            },
                                        })
                                    }
                                />
