...
export default function FarmProfile({ auth, farmer }: FarmersListProps) {
    ...
    console.log(formData.farmer.id);
                        ...
                        <div className="p-10 h-50">
                            ...
                            >
                                ...
                                <input
                                    type="text"
                                    name="farmer_id"
                                    value={formData.farmer?.id || ""} // Ensure farmer_id is read-only and constant
                                    readOnly
                                    onChange={(e) =>
                                        setFormData({
                                            ...formData,
                                            farmer: {
                                                ...formData.farmer,
                                                id: e.target.value, // Not needed since farmer_id is constant
                                            },
                                        })
                                    }
                                />
