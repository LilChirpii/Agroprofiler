...
export default function FarmProfile({ auth, farmer }: FarmersListProps) {
    ...
    return (
        <Authenticated
            ...
            header={
                <h2 className="text-xl mt-2 text-gray-800 leading-tight">
                    <>
                        <div className="flex justify-between w-[300px] bg-green-500">
                            <Link href="/farmers">
        ...
        >
            ...
            <div className="grid grid-cols-4 h-full bg-green-700 gap-0 p-[0.5rem]">
                <div className="relative left-0 h-full bg-gray-400 border-r-3 border-black ">
                    name aksdhjj
                </div>
                <div className="relative col-span-3 right-0 h-full bg-yellow-800">
                    hkdahsdkaj
                </div>
            </div>
        </Authenticated>
