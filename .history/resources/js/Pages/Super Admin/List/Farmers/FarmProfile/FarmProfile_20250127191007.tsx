    ...
    return (
        ...
        >
            ...
            <div className="grid grid-cols-4 h-full gap-0 p-[0.5rem]">
                <div className="relative left-0 h-full border-r-1 shadow-lg px-4 py-2 border-black shadow-[2px_0px_10px_0px_#00000024]">
                    ...
                    <div className="flex content-center justify-center mt-2">
                        {farmer.status === "registered" ? (
                            <>
                                {" "}
                                <div className="bg-green-400 p-1 rounded-2xl text-xs">
                                    {farmer.rsbsa_ref_no}
                                </div>
                            </>
                        ) : (
                            <>
                                <div className="bg-red-500 p-1 rounded-lg text-[10px]">
                                    unregistered
                                </div>
                            </>
                        )}
