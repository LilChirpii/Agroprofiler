...
export default function FarmProfile({ auth, farmer }: FarmersListProps) {
    ...
    return (
        ...
        >
            ...
            <div className="grid grid-cols-2 h-full w-full bg-green-700">
                <div className="relative left-0 h-full w-40 bg-gray-400">
                    name aksdhjj
                </div>
                <div className="relative right-0 w-900 h-full bg-yellow-800">
                    hkdahsdkaj
                </div>
            </div>
        </Authenticated>
