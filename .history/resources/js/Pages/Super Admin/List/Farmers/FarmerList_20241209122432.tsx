    ...
    const fetchFarmerData = () => {
        ...
        axios
            ...
            .then((response) => {
                ...
                const updatedFarmers = response.data.map((farmer: Farmer) => ({
                    ...farmer,
                    barangay: farmer.barangay || { id: null, name: "Not Assigned" },
                }));
                setFarmersData(data);
    ...
    const columns: GridColDef[] = [
        ...
        { field: "age", headerName: "Age", width: 90 },
        {
            ...
            valueGetter: (params: { row: Farmer })  => {
                return params.row.barangay ? params.row.barangay.name : "Not Assigned";
            },
        },
