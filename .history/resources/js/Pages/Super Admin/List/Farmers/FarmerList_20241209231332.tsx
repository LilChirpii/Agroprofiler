                    ...
                    <div className="mt-4">
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="flex gap-5">
                                <select
                                    name="brgy_id"
                                    value={selectedFarmer?.barangay?.id || ""} // Ensure `id` is used as value
                                    onChange={(e) => {
    const barangayId = Number(e.target.value);
    const selectedBarangay = barangays.find((b) => b.id === barangayId);
    setSelectedFarmer({
        ...selectedFarmer,
        barangay: selectedBarangay || { id: 0, name: "Unknown" }, // Default fallback if no barangay is found
        id: selectedFarmer.id ?? 0, // Ensure id is always a number
    });
}}
