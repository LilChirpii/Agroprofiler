...
export default function FarmerList({
    ...
    const columns: GridColDef[] = [
        ...
        { field: "age", headerName: "Age", width: 90 },
        {
            ...
            headerName: "Barangay",
            width: 100,
            // valueGetter: (params: { row: Farmer })  => {
            //     if(!params.row?.barangay?.name){
            //         return "unnkown"
            //     }else{
            //         return params.row.barangay?.name
            //     }
            // },
            renderCell: (params) => ( <span>{params.row?.barangay?.name}</span> ),
        },
        { field: "status", headerName: "Status", width: 100 },
        { field: "sex", headerName: "Sex", width: 70 },
        { field: "4ps", headerName: "4ps", type: "boolean", width: 50,  renderCell: (params) => ( <span>{params.row?.barangay?.name}</span> ),
        {
            field: "actions",
            headerName: "Actions",
            width: 90,
    ...
    const handleEdit = (farmersData: Farmer) => {
        setSelectedFarmer(farmersData);
        console.log("farmersData: Farmer id: ", farmersData);
