...
const UsersList = ({ auth }: UserProps) => {
    ...
    const handleUpdate: FormEventHandler = async (e) => {
        try {
            await axios.post(`/farmers/update/${selectedFarmer.id}`, {
                _method: "PUT",

                firstname: selectedFarmer.firstname,
                lastname: selectedFarmer.lastname,
                dob: selectedFarmer.dob,
                age: selectedFarmer.age,
                sex: selectedFarmer.sex,
                status: selectedFarmer.status,
                coop: selectedFarmer.coop,
                pwd: selectedFarmer.pwd,
                "4ps": selectedFarmer["4ps"],
    ...
    const handleUpdate: FormEventHandler = async (e) => {
        ...
        try {
            ...
            _method: "PUT", toast.success("User updated successfully");
            closeModal();
        } catch (error) {
