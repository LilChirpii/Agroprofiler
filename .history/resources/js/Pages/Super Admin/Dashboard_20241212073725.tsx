...
export default function Dashboard({
    ...
    console.log("allocatios data: ", allocationsData);
    ...
    return (
        ...
        >
            ...
            <div className="grid grid-flow-row grid-rows-1 gap-3 ">
                ...
                <div className="grid grid-flow-col grid-cols-5 gap-2 ">
                    ...
                    <div>
                        <Card title="Farmers">
                            ...
                            <span>Unegistered: {unregisteredFarmers}</span>
                        </Card>
                    </div>
                </div>
                ...
                <Card title="Farmers Distribution">
                    <div>
                        {/* Farmers Distribution */}
                        <select
                            onChange={(e) =>
                                setSelectedFarmerYear(e.target.value)
                            }
                            value={selectedFarmerYear}
                        ...
                        <select
                            onChange={(e) =>
                                setSelectedFarmerSubcategory(e.target.value)
                            }
                            value={selectedFarmerSubcategory}
                            className="rounded-xl"
                        >
                            {subcategories.farmers.map((subcategory) => (
                        ...
                        {/* {farmersData && <BoxPlot data={farmersData} />} */}
                    </div>
                </Card>
                <Card title="Allocations Distribution">
                    <div>
                        <select
                            onChange={(e) =>
                                setSelectedFarmerYear(e.target.value)
                        ...
                        {allocationsData && <BoxPlot data={allocationsData} />}
                    </div>
                </Card>
