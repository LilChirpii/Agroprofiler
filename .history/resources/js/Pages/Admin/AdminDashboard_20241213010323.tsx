...
export default function AdminDashboard({
    ...
    useEffect(() => {
        const fetchAllocationData = async () => {
            try {
                const response = await axios.get("/api/allocation-type-counts");
                    ...
                    <div>
                        <Card title="Allocations">
                            <div className="flex gap-2">
                                ...
                                <div className="min-w-56 min-h-10">
                    ...
                    {Object.entries(commodityCounts).map(
                        ([categoryName, commodities]) => {
                            if (Array.isArray(commodities)) {
                                const chartData = commodities.map(
                                    (commodity: {
                                        name: string;
                                        count: number;
                                    }) => ({
                                ...
                                return (
                                    ...
                                    >
                                        <div className="grid grid-flow-col gap-4">
                                            {/* Div to display commodity names and counts */}
