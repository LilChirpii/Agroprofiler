...
export default function NavBar({ user }: Props) {
    ...
    return (
        <nav className="fixed z-20 ml-4 border-b border-gray-100 w-full">
            <div className="bg-white rounded-[1rem] max-w-screen-xl w-[full] shadow-sm mx-auto px-4 sm:px-6 lg:px-8">
