...
const Heatmap: React.FC<HeatmapProps> = ({
    ...
    return (
        <div className="map-container">
            ...
            /* The above code is conditionally rendering a Modal component if
            the `isModalOpen` flag is true and a `selectedBarangay` is present.
            The Modal component is passed the `selectedBarangay` data and a
            `closeModal` function as props. */
