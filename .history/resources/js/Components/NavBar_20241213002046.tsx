...
export default function NavBar({ user }: Props) {
    ...
    return (
        <nav className="fixed z-20 border-b border-gray-100 min-w-screen">
            <div className="bg-white rounded-[1rem] max-w-screen-xl w-[3000px] shadow-sm mx-auto px-4 sm:px-6 lg:px-8">
