    ...
    const handleOpenModal = () => {
        const tableData = chartData.map((row) => {
            ...
            if (
                ...
                // Extract the category name from distributionType
                const categoryName = distributionType.replace(
                    "commodity_categories_",
                    ""
                );
                ...
                // Add subcategories as table columns
                Object.keys(categoryData).forEach((subcategory) => {
                    // Add subcategory data to rowDetails
                    rowDetails[subcategory] = categoryData[subcategory] || 0;
                    rowDetails.total += categoryData[subcategory] || 0; // Calculate total
                });
            }
